 ...
 *
 * @brief    Obtain a copy of the status string associated to the status code passed, up to
 ...
 *           value is 0x0001.
 *
 * @param    status         The status code of which to obtain the status string.
 *
 ...
 *
 * @return                  The number of characters that would have been written if buffer_length had been
