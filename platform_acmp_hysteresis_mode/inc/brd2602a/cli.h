...
/* The following are configured for BRD2602A */

// ACMP POS input
#if ACMP_POS_INPUT_TYPE == GPIO_PIN
#define ACMP_POS_INPUT      acmpInputPA8 // WSTK EXP header pin 3
#else
...
#define ACMP_NEG_INPUT      acmpInputPA7 // WSTK EXP header pin 5
#else
