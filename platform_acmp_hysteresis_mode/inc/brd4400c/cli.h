...
/* The following are configured for BRD4400C */

// ACMP POS input
#if ACMP_POS_INPUT_TYPE == GPIO_PIN
#define ACMP_POS_INPUT      acmpInputPB4 // WSTK EXP header pin 11
#else
...
#define ACMP_NEG_INPUT      acmpInputPB5 // WSTK EXP header pin 13
#else
