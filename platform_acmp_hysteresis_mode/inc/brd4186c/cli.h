...
/* The following are configured for BRD4186C */

// ACMP POS input
#if ACMP_POS_INPUT_TYPE == GPIO_PIN
#define ACMP_POS_INPUT      acmpInputPA6 // WSTK EXP header pin 11
#else
...
#define ACMP_NEG_INPUT      acmpInputPA7 // WSTK EXP header pin 13
#else
...
// GPIO BUS allocation
#define GPIOBUS             ABUSALLOC

// POS input GPIO bus
#if ACMP_NEG_INPUT_TYPE == GPIO_PIN // Using even GPIO pin
#define ACMP_POS_BUS_ALLOC  GPIO_ABUSALLOC_AEVEN0_ACMP0
#else
...
#define ACMP_NEG_BUS_ALLOC  GPIO_ABUSALLOC_AODD0_ACMP0
#else
