...
![Flash badge](https://img.shields.io/badge/Flash-9.18%20KB-blue)
...
3. Click the **Create** button on the **Platform - Asynchronous EM01GRPA Clock Output** example. The example project creation dialog pops up -> click **Finish** and the project should be generated.
...
2. Copy all attached files in the **inc** and **src** folders into the project root folder (overwriting the existing file).
...
The idea behind this particular example was a customer requirement to provide a 6 MHz CMOS clock output that could serve as the clock source for a companion MCU to the EFR32BG22C112, a cost-optimized member of the EFR32xG22 family that is limited to operation at a maximum of 38.4 MHz.
...
2. Initialize push button 0.
   ...
   The GPIO for the pin connected to push button 0 is initialized and configured to generate interrupt requests on rising edges.
