...
![Flash badge](https://img.shields.io/badge/Flash-11.64%20KB-blue)
...
- Or [Silicon Labs EFM32PG28 Pro Kit Board - PK2506A ](https://www.silabs.com/development-tools/mcu/32-bit/efm32pg28-pro-kit?tab=overview)
...
2. From the Launcher Home, add the `BRD2504A` or `BRD2506` to My Products, click on it, and click on the **EXAMPLE PROJECTS & DEMOS** tab. Find the example project filtering by **iadc** and **high-speed**.
...
6. To observe the output pin pulsing, use the PA5 pin on the EFM32PG23 Pro Kit board or the PB1 pin on the EFM32PG28 Pro Kit board. An edge (including rising or falling) is generated every 1024 samples after about 525 microseconds (uS).
