...
// DCDC B output. During this transition, certain EFP01 settings (inrush current, on-time maximum, peak current)
...
#define SL_DECOUPLE_HANDOFF_ARGS          { 0, 7, 8 } // BK_IRI_CON=0, BK_TON_MAX=7, BK_IPK=8
