...
|:--:|:-------------|:---------------:|
| 1 | Platform - SensiML IMU Recognition | [Click here](./SensiML_IMU/) |
| 2 | Platform - SensiML IMU Recognition with BLE | [Click here](./SensiML_IMU_BLE/) |
| 3 | Platform - SensiML Microphone Recognition | [Click here](./SensiML_Microphone/) |
...
The knowledgepack folder has a structure as shown below:
...
Simplicity Studio projects can link the SensiML library file fairly easily. The following steps should be followed to link a Knowledge Pack Library into Simplicity Studio.

Right-click on the project and go to **Properties.** From there go to **C/C++ Build** → **Settings**:

### Adding the Library ###

Go to **GNU ARM C Linker** → **Libraries**. Link the sensiml library and include the sensiml folder in the search path for the linker.

![Linker Settings](image/project_setting_1.png)

### Adding Include Directories ###

Click on **GNU ARM C Compiler** → **Includes**. Click "**Add**" and add the location of the knowledge pack directory:

![Compiler Settings](image/project_setting_2.png)
